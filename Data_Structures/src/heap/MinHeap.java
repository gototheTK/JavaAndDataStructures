...
public class MinHeap {
    ...
    public int remove() {
        ...
        // 2. 루트노드의 값을 추출하여 반환할 준비를한다.
        int rootKey = queue[0];

        // 3. 루트노드에 최말단 리프 노드를 배치하고 길이 하나 줄인다.
        swap(0, size - 1);
        queue[size - 1] = 0;
        --size;
        // 4. 자식노드들과 우선순위를 비교하여 배치를 반복한다.
        downHeap(0);
    ...
    private void downHeap(int index) {
        ...
        // 1.왼쪽 자식 노드가 존재하는지 확인합니다. 완족 이진 트리이기때문에 왼쪽 자식노드가 없다면 말단 노드인걸 알 수 있습니다.
        ...
        // 3. 자식노드중 우선순위가 가장 큰것과 비교와 배치를 반복하여 배치를 완료합니다.(참고:힙 트리는 완전 트리이기때문에 중간에 비어있지
        // 않습니다.)
        /**
